...
### Lead and Poverty
Figure 1. shows the proportion of pipes within schools that contain lead measurements above 15ppb based on their poverty status. Even though it is not statistically significant, we see a pattern of increase number of pipes containing high levels of lead among those schools with higher proportion of students in the poverty level.    
```{r poverty}
eda_data %>% 
