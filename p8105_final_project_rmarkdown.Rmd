...
An issue that affects the lives of individuals globally, even within developed countries like the United States, is a lack of access to clean drinking water. Contaminants such as lead are not always visible to the eye and can be deleterious to health especially to susceptible populations like that of children. Although schools should allow children safe access to drinking water, recent evaluations have found schools throughout the US to have high levels of lead beyond the set threshold of 15 parts per billion (ppb). It is now well known that exposure to lead, even in low levels, has long lasting effects on neurodevelopment and cognition with an even greater effect when exposure occurs in an early age. Additionally, studies have show that disavantaged populations, such as minorities or those living under the poperty levels, are biasedly affected by lead exposure. The goal of this project is to investigate whether children exposure to lead throughout New York City schools is influence by race or economical status, and whether schools with higher levels of exposures have overall lower standardized math test scores. 

## Related Work
[Review of the effects of lead exposure among children](http://www.nejm.org/doi/full/10.1056/NEJM199001113220203#t=article)

[Pollutant Exposures Among Ethnic Minority and Poor Children](https://www.ncbi.nlm.nih.gov/pubmed/16611170)
...
Our initial questions were whether or not exposure to lead through drinking water varies depending on race and economical status in New York City public schools? And if so, by how much?
...
The compiled dataset has a total of 25 variables and it includes observations from 1116 schools -elementary and middle schools. The ethnic and poverty variables are express in proportions, that is, they show the proportion of students within a school that belong to a specific ethnic category or are considered to be below the poverty threshold (based on the U.S government poverty guidelines). All schools have at least one lead contaminated water outlet, but not all schools have outlets with lead levels about 15ppb. The standardized math test scores for each school were restricted to the average scores for all grades rather than to the scores for each grade. This way, each school has only one overall standardize math test score.  

## Data dictionary 

* number of outlets = the total number of water outlets within a given school. 
* number of outlets greater = the number of outlets with lead levels above 15ppb.
...
Based on our exploratory analysis there is not association between test scores and the number of water outlets containing lead levels above 15ppb. However, through our study we find out that the proportions of highly contaminated pipes tend to be higher in schools that have a large number of students with poverty status. Additionally, schools that are over 50% black tend to also have higher proportion of highly contaminated pipes relative to the other schools. Through our data analysis, we also observed that those schools that have a majority of Black or Hispanic students have lower test scores. These results are similar to the results we were expecting; however, the data-----   
