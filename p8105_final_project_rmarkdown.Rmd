...
**Data [Lead Testing in School Drinking Water Sampling and Results: Most Recently Reported Beginning 2016 API](https://health.data.ny.gov/Health/Lead-Testing-in-School-Drinking-Water-Sampling-and/rkyy-fsv9).**
...
map_data %>% 
  leaflet() %>% 
  addTiles() %>% 
  addMarkers(~longitude, ~latitude, popup = ~as.character(school_name.x), label = ~as.character(school_name.x))
```
